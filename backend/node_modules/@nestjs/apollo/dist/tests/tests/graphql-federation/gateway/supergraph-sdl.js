...
exports.supergraphSdl = void 0;
exports.getSupergraphSdl = getSupergraphSdl;
exports.supergraphSdl = `schema
...
function getSupergraphSdl(usersPort, postsPort) {
    return exports.supergraphSdl
        .replace('http://localhost:3001/graphql', `http://localhost:${usersPort}/graphql`)
        .replace('http://localhost:3002/graphql', `http://localhost:${postsPort}/graphql`);
}
