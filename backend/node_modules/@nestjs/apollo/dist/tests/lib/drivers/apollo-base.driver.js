...
const graphiql_playground_plugin_1 = require("../graphiql/graphiql-playground.plugin");
...
class ApolloBaseDriver extends graphql_1.AbstractGraphQLDriver {
    ...
    async mergeDefaultOptions(options) {
        ...
        if (options.graphiql) {
            const graphiQlPlaygroundOpts = typeof options.graphiql === 'object' ? options.graphiql : {};
            graphiQlPlaygroundOpts.url ??= options.path;
            defaults = {
                ...defaults,
                plugins: [new graphiql_playground_plugin_1.GraphiQLPlaygroundPlugin(graphiQlPlaygroundOpts)],
            };
        }
        ...
        options = await super.mergeDefaultOptions(options, (0, lodash_omit_1.default)(defaults, 'plugins'));
    ...
    subscriptionWithFilter(instanceRef, filterFn, createSubscribeContext) {
        return (...args) => (0, async_iterator_util_1.createAsyncIterator)(createSubscribeContext()(...args), (payload) => filterFn.call(instanceRef, payload, args[1], args[2]));
    }
    async registerExpress(options, { preStartHook } = {}) {
        const { expressMiddleware } = (0, load_package_util_1.loadPackage)('@as-integrations/express5', 'GraphQLModule', () => require('@as-integrations/express5'));
