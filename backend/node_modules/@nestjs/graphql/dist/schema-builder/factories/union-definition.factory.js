...
const union_member_not_object_type_error_1 = require("../errors/union-member-not-object-type.error");
...
let UnionDefinitionFactory = class UnionDefinitionFactory {
    ...
    create(metadata) {
        const getObjectType = (item) => {
            ...
            if (!definition) {
                throw new union_member_not_object_type_error_1.UnionMemberNotObjectTypeError(metadata.name, item);
            }
