...
class CannotDetermineInputTypeError extends Error {
    constructor(hostType, typeRef, isRegisteredAsObjectType) {
        const inputObjectName = typeof typeRef === 'function' && typeRef.name;
        if (isRegisteredAsObjectType && inputObjectName) {
            super(`Cannot use "${inputObjectName}" as a GraphQL input type for the "${hostType}" field because it is decorated with @ObjectType(). ` +
...
//# sourceMappingURL=cannot-determine-input-type.error.js.map