...
const normalize_enum_default_value_helper_1 = require("../helpers/normalize-enum-default-value.helper");
        ...
        args.forEach((param) => {
            if (param.kind === 'arg') {
                ...
                fieldConfigMap[param.name] = {
                    ...
                    defaultValue: (0, normalize_enum_default_value_helper_1.normalizeEnumDefaultValue)(param.options.defaultValue, typeRef, type_metadata_storage_1.TypeMetadataStorage.getEnumsMetadata()),
                };
            }
    ...
    inheritParentArgs(argType, options, fieldConfigMap = {}) {
        ...
        argType.properties.forEach((field) => {
            ...
            fieldConfigMap[schemaName] = {
                ...
                type,
                defaultValue: (0, normalize_enum_default_value_helper_1.normalizeEnumDefaultValue)(field.options.defaultValue, typeRef, type_metadata_storage_1.TypeMetadataStorage.getEnumsMetadata()),
                /**
