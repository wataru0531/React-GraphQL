        ...
        return () => {
            ...
            metadata.properties.forEach((property) => {
                ...
                fields[property.schemaName] = {
                    ...
                    type,
                    defaultValue: (0, normalize_enum_default_value_helper_1.normalizeEnumDefaultValue)(property.options.defaultValue, typeRef, type_metadata_storage_1.TypeMetadataStorage.getEnumsMetadata()),
