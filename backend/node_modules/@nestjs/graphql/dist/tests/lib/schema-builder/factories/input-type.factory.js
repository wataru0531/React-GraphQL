    ...
    create(hostType, typeRef, buildOptions, typeOptions = {}) {
        ...
        if (!inputType) {
            ...
            if (!inputType) {
                ...
                throw new cannot_determine_input_type_error_1.CannotDetermineInputTypeError(hostType, typeRef, isRegisteredAsObjectType);
            }
        }
