...
let AstDefinitionNodeFactory = class AstDefinitionNodeFactory {
    ...
    createEnumTypeNode(name, directives) {
        if ((0, shared_utils_1.isEmpty)(directives)) {
            return;
        }
        return {
...
//# sourceMappingURL=ast-definition-node.factory.js.map