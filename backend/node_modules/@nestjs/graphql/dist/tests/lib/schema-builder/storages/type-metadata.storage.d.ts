...
export declare class TypeMetadataStorageHost {
    ...
    getInterfaceMetadataByTarget(target: Function): InterfaceMetadata | undefined;
    ...
    applyPluginMetadata(prototype: Function, loadedClasses?: Set<Function>): void;
