 ...
 * @publicApi
 */
export declare function ResolveField(options?: ResolveFieldOptions): MethodDecorator;
/**
 ...
 * @publicApi
 */
export declare function ResolveField(propertyName?: string, options?: ResolveFieldOptions): MethodDecorator;
/**
 * Property resolver (method) Decorator.
 *
 * @publicApi
