...
let GraphQLFederationFactory = class GraphQLFederationFactory {
    ...
    async generateSchemaFromCodeFirst(options, buildFederatedSchema) {
        ...
        const apolloSubgraphVersion = (await Promise.resolve().then(() => tslib_1.__importStar(require('@apollo/subgraph/package.json')))).version;
        ...
        const resolvers = this.getResolvers(options.resolvers);
        let executableSchema = (0, schema_1.addResolversToSchema)({
...
//# sourceMappingURL=graphql-federation.factory.js.map