...
const collections_1 = require("../../../lib/schema-builder/collections/");
describe('FieldDirectiveCollection', () => {
    ...
    it('should keep a list of all SDLs added', () => {
        const map = new collections_1.FieldDirectiveCollection();
        map.add(directive1);
        map.add(directive2);
        map.add(directive3);
...
//# sourceMappingURL=field-directive.collection.spec.js.map