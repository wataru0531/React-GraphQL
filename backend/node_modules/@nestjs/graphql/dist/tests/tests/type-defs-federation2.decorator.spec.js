...
const type_defs_federation2_decorator_1 = require("../lib/federation/type-defs-federation2.decorator");
describe('TypeDefsFederation2Decorator', () => {
    let decorator;
    beforeEach(() => {
        decorator = new type_defs_federation2_decorator_1.TypeDefsFederation2Decorator();
    });
    describe('decorate', () => {
        it('should default to federation v2.12 import url', () => {
            const result = decorator.decorate('type Query { hello: String }');
            expect(result).toContain('url: "https://specs.apollo.dev/federation/v2.12"');
        });
        ...
        it('should respect a user-provided importUrl override', () => {
            ...
            expect(result).toContain('url: "https://specs.apollo.dev/federation/v2.3"');
        });
...
//# sourceMappingURL=type-defs-federation2.decorator.spec.js.map